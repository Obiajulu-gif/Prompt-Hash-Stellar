...
Design backlog for the core product routes. These issues are intended to drive route-level redesign work before implementation.
...
- Focus:
  ...
  - improved prompt cards and purchase modal
  - mobile-specific browse treatments
...
- Focus:
  ...
  - better management split between creating and managing prompts
  - stronger validation and success states
...
- Focus:
  ...
  - clearer empty, loading, and failure states
...
- Focus:
  ...
  - better disconnected and empty states
  - improved prompt library structure
